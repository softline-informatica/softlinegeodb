...
La base de datos de códigos postales oficial de Correos siempre ha sido de pago, y desde hace un tiempo ofrece varias versiones. Los precios van desde 800 € a 5.000 €
...
El siguiente artículo de _Pablo Barrachina_ es el que motivó la creación de "softlinegeodb" en 2016:
...
El siguiente es un fantástico trabajo de _Francisco Goerlich_ y es casi un tratado en códigos postales. Para los interesados en obtener cartografía actualizada de los códigos postales en España:
...
"Soft Line GeoDB" es un trabajo de _Juan Gabriel Covas_ para **SOFT LINE Informática**. 2016 - 2023. Basado en el artículo [Relacionar el Código INE con su Código Postal](http://switchoffandletsgo.blogspot.com/2013/04/relacionar-el-codigo-ine-con-su-codigo.html) de _Pablo Barrachina_

Uso libre de "Softlinegeodb". Las modificaciones, si se distribuyen, deben hacerse con código fuente.
[Licencia GPL-3.0](https://github.com/softline-informatica/softlinegeodb/blob/main/LICENSE)
